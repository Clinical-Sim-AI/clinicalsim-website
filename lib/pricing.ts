...
export const pricingPageData: PricingPageData = {
  ...
  tiers: [
    ...
    },
    {
      ...
      features: [
        ...
        "ACGME Milestones 2.0 reporting — structured competency tracking built in, not bolted on",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Individual gives you full access to practice scenarios and your own performance dashboard. Program adds the institutional layer: a faculty admin dashboard so program directors and administrators can view every learner\u2019s performance, CCC-ready documentation from every session, ACGME Milestones 2.0 reporting, program-level analytics, dedicated onboarding, and custom scenario creation.",
    },
    {
