...
export async function GET() {
  ...
  const otherPages = [
    ...
    `- [ROI Calculator](${BASE_URL}/roi-calculator): A break-even calculator for residency program directors and DIOs, covering faculty assessment time (6.7 hours per trainee per year, Goyal 2018), remediation faculty time, and the extended-year threshold. Every constant carries a source, year, and confidence tag; the model can return a losing result; nothing entered is transmitted.`,
