...
AI patients can add repeatable practice between scheduled encounters, with each conversation scored against the ICS milestone language the CCC reviews and the learner's own words quoted under every score. That gives faculty another view of where communication breaks down, learner by learner, without turning a practice score into an entrustment or progression decision.
