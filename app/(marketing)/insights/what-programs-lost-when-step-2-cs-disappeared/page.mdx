...
AI patients can add repeatable practice between scheduled encounters, with each conversation scored against the ICS milestone language the CCC reviews and the learner's own words quoted under every score. Learners and faculty can review strengths and areas for practice across repeated attempts without turning a practice score into an entrustment or progression decision.
