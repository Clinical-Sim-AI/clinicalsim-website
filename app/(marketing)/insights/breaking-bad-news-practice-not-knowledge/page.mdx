...
Communication assessment is stronger when a committee can review repeated observations across encounters. A practice transcript and framework-based report can add another source of evidence, but it does not replace faculty observation or the committee's judgment.
...
AI patient simulation can shorten the practice cycle. A learner can repeat a breaking bad news conversation, review structured feedback, and bring specific questions to the next faculty or SP session. The frameworks are already there, including SPIKES, Calgary-Cambridge, and Kalamazoo. The practical need is more chances to use them aloud.
