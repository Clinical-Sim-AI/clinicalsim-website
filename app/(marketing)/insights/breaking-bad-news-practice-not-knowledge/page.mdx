...
Standardized patients can do this, and they do it well. But SP encounters require actor time, space, faculty support, and scheduling, which makes it hard to provide the volume that struggling learners need.

AI patient simulation can shorten the practice cycle. A learner can repeat a breaking bad news conversation, see each SPIKES step scored with their own words quoted under it, and bring the step they keep missing to the next faculty or SP session. The frameworks are already there, including SPIKES, Calgary-Cambridge, and Kalamazoo. The practical need is more chances to use them aloud, and a score against the framework each time so the learner knows what changed.
