...
<KeyTakeaway stat="25-75 hrs" statSource="faculty hours per remediation case (Kalet & Chou, Remediation in Medical Education, 2014)">
Communication is the hardest competency to remediate, and the traditional approach doesn't scale: a single case consumes 25 to 75 faculty hours, and with 93% of programs facing remediation, most rebuild their method from scratch every time.
</KeyTakeaway>
