...
The CERA survey found that missing documentation often delays or weakens remediation. A useful [communication-remediation record](/insights/communication-remediation-plan) shows the assigned skill, the standard used to assess it, what the learner actually said, and whether the same behavior changed on later attempts.
