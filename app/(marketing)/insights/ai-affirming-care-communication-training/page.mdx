...
The Rome presentation lays out how this works in practice. We'll share more after the conference. For programs looking to build communication competency in affirming care without waiting for the political environment to settle, free early access is available at [platform.clinicalsim.ai](https://platform.clinicalsim.ai).
