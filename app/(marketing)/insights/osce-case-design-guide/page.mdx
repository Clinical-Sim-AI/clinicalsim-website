...
AI patients can add repeatable spoken practice before an OSCE, scored against the same rubric the station will use, with the learner's own words quoted under every score. They are useful when learners need another attempt and faculty need to see which item broke down before coaching. Standardized patients and faculty should keep the live assessment and human judgment that high-stakes decisions require.

[Review unedited ClinicalSim encounters](/examples).
