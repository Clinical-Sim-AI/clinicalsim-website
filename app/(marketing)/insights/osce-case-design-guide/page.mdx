...
The [encounters we publish](/examples) show what that looks like in practice, because a voice-only format makes the problem unavoidable. A [leukemia disclosure](/examples/delivering-a-new-leukemia-diagnosis-to-a-family-in-the-emergency-department) scored against SPIKES totals 25 out of 30, and the first step, setting up the interview, comes back at 3 out of 5 with the reason stated: privacy, seating, and interruption management cannot be assessed in a voice-only encounter, so the score rests only on the elements that could be. A [vaccine hesitancy encounter](/examples/pediatric-vaccine-hesitancy-counseling) marks privacy not assessable in a spoken format for the same reason.
